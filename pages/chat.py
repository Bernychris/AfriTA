...
# BANDEAU VIOLET
st.markdown("""
<div style="background: linear-gradient(90deg, #9c27b0, #7b1fa2); padding: 0.5rem; border-radius: 10px; margin-bottom: 1rem;">
    <p style="color: white; text-align: center; margin: 0; font-weight: bold;">🟣 SERVICE CHAT - TRANSPORT FÉLIN</p>
</div>
...
# ==================== DISTANCES (Afrique centrale uniquement) ====================
distances_connues = {

        ...
        if os.path.exists("factures.csv"):
            ...
            if len(facture) > 0:
                ...
                <div style="background: white; padding: 1.5rem; border-radius: 15px; margin-top: 1rem; border: 1px solid #ddd;">
                    ...
                    <p><strong style="color: #333;">📄 Numéro :</strong> <span style="color: #555;">{f['Numero']}</span></p>
                    ...
                    <p style="font-size: 1.2rem; margin: 0;"><strong style="color: #2d8c3e;">💰 Montant total :</strong> <strong style="color: #e91e63;">{int(f['Prix']):,} FCFA</strong></p>
                    <p style="margin: 5px 0 0 0;"><strong style="color: #333;">📌 Statut :</strong> <span style="color: #555;">{f['Statut']}</span></p>
                    
                    <hr>
                    
                    <p style="text-align: center; color: #888; font-size: 0.8rem; margin: 0;">
